...
write(20,*) 'zone t="top",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
...
write(20,*) 'zone t="bottom",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
...
write(25,*) 'zone t="top",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.5-dx) ) .and. ( x(i).le.(5.5+dx) ) .and. (y(j).ge.5.5)) then
   write (25,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(25,*) 'zone t="bottom",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.5-dx) ) .and. ( x(i).le.(5.5+dx) ) .and. (y(j).le.4.5)) then
   write (25,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(30,*) 'zone t="top",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.5-dx) ) .and. ( x(i).le.(5.5+dx) ) .and. (y(j).ge.5.5)) then
   write (30,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(30,*) 'zone t="bottom",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.5-dx) ) .and. ( x(i).le.(5.5+dx) ) .and. (y(j).le.4.5)) then
   write (30,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(35,*) 'zone t="top",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.5-dx) ) .and. ( x(i).le.(5.5+dx) ) .and. (y(j).ge.5.5)) then
   write (35,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(35,*) 'zone t="bottom",i=',floor(nx/(10/4.5)+1),',j=',floor(ny/10.+1)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.5-dx) ) .and. ( x(i).le.(5.5+dx) ) .and. (y(j).le.4.5)) then
   write (35,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
!
write(*,777) time, r(nx/2-0.6,ny/2)
