module Legendre
  ...
  real(kind=8), save, allocatable:: Fold(:,:,:,:,:)
  real(kind=8), save, allocatable:: F_ns(:,:,:,:,:,:),F_s(:,:,:,:,:,:)
...
contains
  ...
  !==============================================================================
  subroutine alloc_mem_u(PD1,PD2,PN1,PN2,TDM,rks)
  implicit none
  integer::ierr,PD1,PD2,TDM,PN1,PN2,rks

 allocate(  flx_F(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM) )
  allocate( F_alt(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM),&
            Fold(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM), &
            F_new(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM), &
              F_t(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM),&
              F_s(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM,1:rks),&
              F_ns(1:IGH,1:IGH,0:PD1,0:PD2,1:TDM,1:rks),&
...
!            FS_tmp(0:PN1,0:PN2),&
!            exa_solij(1:IGH,1:IGH,0:PN1,0:PN2,1:TDM),&
