...
contains
  ...
  subroutine alloc_mem_metric_variables(Deg1_Max,Deg2_Max,TotNumDomain)
    implicit none
    integer:: Deg1_Max, Deg2_Max, Deg3_Max, TotNumDomain

    integer:: ierr
    
    allocate( &
         DM_Metric(0:Deg1_Max,0:Deg2_Max,1:TotNumDomain), &
           Jacobin(0:Deg1_Max,0:Deg2_Max,1:TotNumDomain), &
