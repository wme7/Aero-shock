!
! pjk  (j,k = 0,1,2,3,4) : the coefficients of the k-th degree term of the polynomial pj by
!      weno5, e.g.,p12 represents the 2nd-degree term (x^2) of the polynomial p1(x) by weno5
!
! dpjk (j,k = 0,1,2,3,4) : the coefficient of the k-th degree term of the derivative of the
!      polynomial pj by weno5
!
...
!
!
      subroutine weno5(uun,uup,uu)
      implicit none
      real(kind=2):: uu(-4:4), uun, uup
      real(kind=2):: b0, b1, b2, b3, b4, dx, wsum, eps

      real(kind=2):: p00, p01, p02, p03, p04, &
     &               p10, p11, p12, p13, p14, &
     &               p20, p21, p22, p23, p24, &
     &               p30, p31, p32, p33, p34, &
     &               p40, p41, p42, p43, p44

      real(kind=2):: rn0, rn1, rn2, rn3, rn4, &
     &               rp0, rp1, rp2, rp3, rp4, &
     &               wn0, wn1, wn2, wn3, wn4, &
     &               wp0, wp1, wp2, wp3, wp4

      real(kind=2):: dp01, dp02, dp03, dp04, &
     &               dp11, dp12, dp13, dp14, &
     &               dp21, dp22, dp23, dp24, &
     &               dp31, dp32, dp33, dp34, &
     &               dp41, dp42, dp43, dp44
